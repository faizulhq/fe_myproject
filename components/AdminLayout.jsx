...
export default function AdminLayout({ children }) {
  ...
  // Menu disesuaikan dengan kebutuhan CRUD Anda saja
  const menuItems = [
    {
      key: '1',
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout style={{ marginLeft: collapsed ? 80 : 240, transition: 'all 0.2s', background: '#000' }}>
        ...
        <Header style={{ 
          padding: '0 24px', 
          background: 'rgba(17, 17, 17, 0.8)', // Semi transparan
          ...
          <Dropdown menu={{ items: [{ key: '1', label: 'Logout', icon: <LogoutOutlined />, danger: true }] }}>
